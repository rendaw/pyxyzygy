package com.zarbosoft.internal.pyxyzygy_generate;
...
import com.zarbosoft.internal.pyxyzygy_seed.deserialize.*;
...
import com.zarbosoft.internal.pyxyzygy_seed.model.ProjectObjectInterface;
...
import static com.zarbosoft.internal.pyxyzygy_generate.GenerateTask.decideName;
import static com.zarbosoft.internal.pyxyzygy_generate.GenerateTask.flattenPoint;
...
public class GenerateModel {
	...
	public ClassName name(String... parts) {
		return ClassName.get("com.zarbosoft.pyxyzygy.model", Arrays.stream(parts).collect(Collectors.joining("_")));
	}
	...
	public void buildModel() {
		...
		for (Class klass : new ClassGraph()
				.enableAllInfo()
				.whitelistPackages("com.zarbosoft.internal.pyxyzygy_generate.premodel")
				.scan()
				.getSubclasses("com.zarbosoft.internal.pyxyzygy_seed.model.ModelRootType")
				.loadClasses()) {
