...
public class TrueColor {
  @Configuration public byte r;
  @Configuration public byte g;
  @Configuration public byte b;
  @Configuration public byte a;

  public static TrueColor BLACK = TrueColor.rgba(0, 0, 0, 0);
  ...
  public static class Deserializer extends StackReader.State {
    ...
    public void value(Object value) {
      ...
      if ("r".equals(key)) out.r = (byte) Integer.parseInt(text);
      else if ("g".equals(key)) out.g = (byte) Integer.parseInt(text);
      else if ("b".equals(key)) out.b = (byte) Integer.parseInt(text);
      else if ("a".equals(key)) out.a = (byte) Integer.parseInt(text);
      else throw new RuntimeException(String.format("Unknown field %s", key));
      key = null;
    }
