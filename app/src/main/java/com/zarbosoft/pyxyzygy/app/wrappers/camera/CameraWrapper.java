...
public class CameraWrapper extends GroupNodeWrapper {
	...
	private SimpleObjectProperty<com.zarbosoft.pyxyzygy.seed.model.Rectangle> crop =
			new SimpleObjectProperty<>(new com.zarbosoft.pyxyzygy.seed.model.Rectangle(0, 0, 0, 0));
